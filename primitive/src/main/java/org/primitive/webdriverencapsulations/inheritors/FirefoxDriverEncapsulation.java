...
public final class FirefoxDriverEncapsulation extends WebDriverEncapsulation{	
	...
	public FirefoxDriverEncapsulation(FirefoxProfile profile, Configuration config)	{
		createWebDriver(ESupportedDrivers.FIREFOX.getUsingWebDriverClass(), new Class<?>[] {FirefoxProfile.class}, new Object[] {profile});
	...
	public FirefoxDriverEncapsulation(Capabilities desiredCapabilities, Capabilities requiredCapabilities, Configuration config)	{
		createWebDriver(ESupportedDrivers.FIREFOX.getUsingWebDriverClass(), new Class<?>[] {Capabilities.class, Capabilities.class}, new Object[] {desiredCapabilities, requiredCapabilities});
		resetAccordingTo(config);
	}
	...
	public FirefoxDriverEncapsulation(FirefoxBinary binary, FirefoxProfile profile, Configuration config)	{
		createWebDriver(ESupportedDrivers.FIREFOX.getUsingWebDriverClass(), new Class<?>[] {FirefoxBinary.class, FirefoxProfile.class}, new Object[] {binary, profile});
		resetAccordingTo(config);
	}
	
	public FirefoxDriverEncapsulation(FirefoxBinary binary, FirefoxProfile profile, Capabilities capabilities, Configuration config)	{
	...
	public FirefoxDriverEncapsulation(FirefoxBinary binary, FirefoxProfile profile, Capabilities desiredCapabilities, Capabilities requiredCapabilities, Configuration config)	{
