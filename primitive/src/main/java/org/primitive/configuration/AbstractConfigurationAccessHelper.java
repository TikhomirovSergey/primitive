...
/**
 * @author s.tihomirov
 * Inheritors of this class should make access to configuration data easier
 */
public abstract class AbstractConfigurationAccessHelper implements IGroupedSetting{
