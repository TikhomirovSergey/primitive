...
enum EServices {
	CHROMESERVICE(Configuration.byDefault.getChromeDriverSettings(),
			ChromeDriverService.CHROME_DRIVER_EXE_PROPERTY, "chromedriver.exe"), 
	IEXPLORERSERVICE(Configuration.byDefault.getIEDriverSettings(),
			InternetExplorerDriverService.IE_DRIVER_EXE_PROPERTY,
			"IEDriverServer.exe"), 
	PHANTOMJSSERVICE(Configuration.byDefault.getPhantomJSDriverSettings(),
	...
	private EServices(IHasPathToFile filePaths, String propertyName,
