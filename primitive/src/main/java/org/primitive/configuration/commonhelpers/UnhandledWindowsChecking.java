...
/**
 * @author s.tihomirov for situations when unhandled alerts and windows are need
 *         to be checked
 */
public class UnhandledWindowsChecking extends AbstractConfigurationAccessHelper
	...
	public TimeUnit getTimeUnit() {
		String timeUnitStr = (String) getSettingValue(
				unhandledWindowsCheckingGroup, timeUnitSetting);
		if (timeUnitStr != null) {
