...
public abstract class TestObject implements IDestroyable, IDecomposable {
	/**
	 * @author s.tihomirov It should intercept invocation of TestObject and its
	 *         inheritors methods
	 */
	public abstract static class Interceptor implements MethodInterceptor {
		...
		protected Object handleException(TestObject testObject,
				Method originalMethod, MethodProxy methodProxy, Object[] args,
				Throwable t) throws Throwable {
			return testObject.exceptionHandler.handleException(testObject,
					originalMethod, methodProxy, args, t);
		}

		@Override
		public abstract Object intercept(Object arg0, Method arg1,
	...
	private ITestObjectExceptionHandler exceptionHandler = (ITestObjectExceptionHandler) Proxy
			.newProxyInstance(
	...
	protected static <T extends IDecomposable> T getProxy(Class<T> clazz,
